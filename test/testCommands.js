...
function Instance(baseDir) {
  ...
  return git = new Git(baseDir, new MockChildProcess, {
    concat: sinon.spy(function (things) {
...
exports.getBranchList = {
  ...
  'get right branch list': function (test) {
    git.getBranchList(function (err, result) {
      test.equals(null, err, 'not an error');
